...
public class GoogleMapView extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.sendLocation)).setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( GoogleMapView.this, REQUIRED_PERMISSIONS,
...
//    }
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(GoogleMapView.this);
